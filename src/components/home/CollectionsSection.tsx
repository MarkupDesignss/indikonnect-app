    ...
    >
      <div className="max-w-[1650px] mx-auto px-8">
        ...
        <div
          ...
          className="relative mt-16 flex gap-10 items-start overflow-x-auto pb-6 snap-x snap-mandatory"
          style={{
        ...
        {/* Bottom Navigation */}
        <div className="mt-20 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
          {/* Left */}
