  ...
  return (
    ...
    >
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <h2
          className="max-w-[820px] leading-[0.92]"
          style={{
        ...
        <p
          className="mt-8 max-w-[760px] text-[24px] leading-[1.7]"
          style={{
            color: "#575757",
            fontFamily: getFont("jost"),
            fontWeight: FONT_WEIGHT.regular,
        ...
        <div className="mt-24 grid lg:grid-cols-[1fr_auto_1fr] gap-16 items-stretch">
          ...
          >
            ...
            <p
              className="max-w-[430px] text-[24px] leading-[1.7]"
              style={{
        ...
        <div className="mt-20 pt-12 border-t border-[#E5D6B1]/30 text-center">
          <h3
          ...
          <p
            className="mt-4 max-w-[580px] mx-auto text-[18px] leading-[1.8]"
            style={{
              color: "#575757",
              fontFamily: getFont("jost"),
              fontWeight: FONT_WEIGHT.regular,
