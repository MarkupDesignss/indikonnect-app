...
/* =========================================================
   LINK COLUMN COMPONENT - WITH STYLISH UNDERLINE ON HOVER
========================================================= */
...
function LinkColumn({
  ...
  return (
    <div className="min-w-0">
      <h3 className="mb-5 flex items-center justify-between border-b border-[#1B1A3B]/[0.07] pb-4 font-mono text-[11px] font-bold uppercase tracking-[0.4em] text-[#1B1A3B]/45">
        <span>{title}</span>

        <span className="text-[#E8590C]/75">{number}</span>
      </h3>
      ...
      <ul className="flex flex-col">
        {links.map((link) => (
          <li key={link.label}>
            <Link
              href={link.href}
              className="group relative flex items-center gap-2 py-3 text-[16px] font-semibold tracking-[0.06em] text-[#1B1A3B] transition-colors duration-300 hover:text-[#E8590C]"
            >
              {/* Stylish Underline */}
              <span className="absolute bottom-0 left-0 h-[2.5px] w-0 bg-gradient-to-r from-[#FF6A00] via-[#FFA94D] to-[#E8590C] transition-all duration-500 ease-out group-hover:w-full" />

              {/* Second underline with glow effect */}
              <span className="absolute bottom-[-1px] left-0 h-[3.5px] w-0 bg-gradient-to-r from-[#FF6A00]/30 via-[#FFA94D]/30 to-[#E8590C]/30 blur-[2.5px] transition-all duration-700 ease-out group-hover:w-full" />

              <span className="h-2 w-2 scale-0 rounded-full bg-[#E8590C] opacity-0 transition-all duration-300 group-hover:scale-100 group-hover:opacity-100" />

              <span>{link.label}</span>

              {link.tag && (
                <span className="rounded-[3px] bg-[#FFF0DE] px-1.5 py-0.5 font-mono text-[8px] font-semibold uppercase tracking-[0.15em] text-[#E8590C]">
                  {link.tag}
                </span>
              )}
            </Link>
...
export default function Footer() {
  ...
  return (
    <footer className="ik-footer relative overflow-hidden bg-[#FAF8F6] text-[#1B1A3B] tracking-[0.02em]">
      {/* =====================================================
          WATERMARK - WITH ENHANCED BLUR (INCREASED TO 12px)
      ===================================================== */}
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1440px] px-5 sm:px-8 lg:px-12">
        ...
        {/* ===================================================
            ...
            IMPORTANT:
            BRAND + SUPPORT + LEGAL + QUICK LINKS
            ALL IN SAME ROW ON DESKTOP
        =================================================== */}
        ...
        <motion.div
          ...
          className="
            ...
            py-12
            md:grid-cols-2
            lg:grid-cols-[1.45fr_0.8fr_0.8fr_0.8fr_1.15fr]
            lg:items-start
            lg:gap-8
            lg:py-16
            xl:grid-cols-[1.5fr_0.8fr_0.8fr_0.8fr_1.2fr]
            xl:gap-10
          "
        >
          {/* =================================================
              BRAND - WITH ENHANCED CONTACT INFO
          ================================================= */}
          ...
          <motion.div variants={itemVariants}>
            ...
            <p className="mb-7 max-w-[340px] text-[15px] font-normal tracking-[0.03em] leading-[1.8] text-[#1B1A3B]/60">
              {footer?.title ||
            ...
            {/* ================================================
                CONTACT INFO - ENHANCED & HIGHLIGHTED
            ================================================ */}
            ...
            <div className="mb-8 flex flex-col gap-3.5">
              ...
              {footer?.email && (
                ...
                >
                  {/* Underline for email */}
                  <span className="absolute bottom-0 left-0 h-[2px] w-0 bg-gradient-to-r from-[#FF6A00] via-[#FFA94D] to-[#E8590C] transition-all duration-500 ease-out group-hover:w-full" />
                  <span className="absolute bottom-[-1px] left-0 h-[3px] w-0 bg-gradient-to-r from-[#FF6A00]/30 via-[#FFA94D]/30 to-[#E8590C]/30 blur-[2px] transition-all duration-700 ease-out group-hover:w-full" />
              ...
              {footer?.location && (
                <span className="group relative flex w-fit items-center gap-3 font-mono text-[15px] font-semibold tracking-[0.04em] text-[#1B1A3B]/75">
          ...
          {/* =================================================
              SUPPORT - WITH STYLISH UNDERLINE & BIGGER SIZE
          ================================================= */}

          <motion.div className="lg:pl-4 xl:pl-56" variants={itemVariants}>
            <h3 className="mb-5 flex items-center justify-between border-b border-[#1B1A3B]/[0.07] pb-4 font-mono text-[11px] font-bold uppercase tracking-[0.4em] text-[#1B1A3B]/45">
              <span>Support</span>
            ...
            <ul className="flex flex-col">
              {supportLinks.map(({ label, icon: Icon, href }) => (
                <li key={label}>
                  <Link
                    href={href}
                    className="group relative flex items-center gap-3 py-3 text-[16px] font-semibold tracking-[0.06em] text-[#1B1A3B] transition-colors duration-300 hover:text-[#E8590C]"
                  >
                    {/* Stylish Underline */}
                    <span className="absolute bottom-0 left-0 h-[2.5px] w-0 bg-gradient-to-r from-[#FF6A00] via-[#FFA94D] to-[#E8590C] transition-all duration-500 ease-out group-hover:w-full" />
                    <span className="absolute bottom-[-1px] left-0 h-[3.5px] w-0 bg-gradient-to-r from-[#FF6A00]/30 via-[#FFA94D]/30 to-[#E8590C]/30 blur-[2.5px] transition-all duration-700 ease-out group-hover:w-full" />

                    <Icon className="h-[18px] w-[18px] text-[#FF8A2B] transition-transform duration-300 group-hover:scale-110" />
              ...
              {footer?.phone && (
                <li>
                  <a
                    href={`tel:${footer.phone.replace(/\s/g, "")}`}
                    className="group relative flex items-center gap-3 py-3 text-[16px] font-semibold tracking-[0.06em] text-[#E8590C] transition-colors duration-300 hover:text-[#E8590C]"
                  >
                    {/* Stylish Underline */}
                    <span className="absolute bottom-0 left-0 h-[2.5px] w-0 bg-gradient-to-r from-[#FF6A00] via-[#FFA94D] to-[#E8590C] transition-all duration-500 ease-out group-hover:w-full" />
                    <span className="absolute bottom-[-1px] left-0 h-[3.5px] w-0 bg-gradient-to-r from-[#FF6A00]/30 via-[#FFA94D]/30 to-[#E8590C]/30 blur-[2.5px] transition-all duration-700 ease-out group-hover:w-full" />
          ...
          {/* =================================================
              LEGAL - WITH STYLISH UNDERLINE & BIGGER SIZE
          ================================================= */}
          ...
          {/* =================================================
              QUICK LINKS - WITH STYLISH UNDERLINE & BIGGER SIZE
          ================================================= */}
