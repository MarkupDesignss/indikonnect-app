...
const transformWishlistItem = (item: WishlistItem): TransformedWishlistItem => {
...
export default function WishlistComponent({ onItemClick }: WishlistComponentProps) {
        ...
        return (
            <div className="flex items-center justify-center py-16">
                <div className="flex flex-col items-center gap-3">
                    ...
                    <span className="text-sm text-gray-400">Loading wishlist...</span>
                </div>
            </div>
        );
    }
    ...
    if (wishlistItems.length === 0) {
        return (
            ...
            >
                ...
                >
                    <Heart className="w-24 h-24 text-gray-200 mx-auto" strokeWidth={0.5} />
                    <motion.div
                ...
                {wishlistItems.map((item) => (
                    ...
                    >
                        ...
                        <button
                            ...
                            className="absolute top-3 right-3 z-10 p-1.5 bg-white/90 backdrop-blur-sm rounded-full shadow-sm hover:bg-red-50 hover:text-red-500 transition-colors group-hover:opacity-100 opacity-70 disabled:opacity-50"
                        >
                            <Trash2 className="w-4 h-4 text-gray-500 hover:text-red-500 transition-colors" />
                        </button>

                        <div onClick={() => handleItemClick(item.slug)} className="cursor-pointer">
                            {/* Image */}
                            <div className="relative aspect-square bg-gray-100 overflow-hidden">
                                <Image
                                    ...
                                    onError={(e) => {
                                        ...
                                        target.src = '/indiekonnect-web/images/placeholder.jpg';
                                    }}
                                />
                                {item.discount && (
                                    <span className="absolute top-3 right-12 bg-red-500 text-white px-2 py-0.5 rounded-full text-[10px] font-bold">
                                        -{item.discount}%
                                    </span>
                                )}
                                {!item.inStock && (
                            ...
                            <div className="p-3">
                                ...
                                <div className="flex items-center justify-between mt-2 pt-2 border-t border-gray-100">
                                    ...
                                    <button
                                        ...
                                        className={`p-1.5 rounded-lg transition-colors flex items-center gap-1 text-[10px] ${item.inStock && !isAddingToCart
