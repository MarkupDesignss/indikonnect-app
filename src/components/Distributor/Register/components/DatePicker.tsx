        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              onBlur={onYearBlur}
              className="w-16 text-center font-semibold text-gray-900 border-b-2 border-transparent focus:border-[#F9C744] outline-none px-1 py-0.5 bg-transparent"
              placeholder="Year"
              maxLength={4}
            />
          </div>
          ...
          {days.map((day, index) => {
            ...
            return (
              <button
                ...
                ${isDisabled ? "text-gray-300 cursor-not-allowed" : "text-gray-900 hover:bg-[#F9C744]/20"}
