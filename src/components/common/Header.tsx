...
export default function Header({
  ...
  return (
    <>
      <header
        className={`bg-white border-b border-[#e9e1d0] sticky top-0 z-40 transition-shadow duration-300 ${
                      ...
                      <div className="py-2">
                        {profileMenuItems.map((item, index) => (
                          <motion.button
                            ...
                            className={`flex items-center gap-3 w-full px-4 py-2.5 text-sm text-gray-600 hover:bg-gray-50 hover:text-[#C9A227] transition-colors ${
                              item.label === "Logout"
